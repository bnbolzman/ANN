...
function FORWARD_PROPAGATION(x, w1, w2){
  ...
  //For ease of math the following terms have been condensed into shorter math terms
  // x -> is input
  ...
  // y_hat -> is the ANN's best guess (the output that the ANN returns)
...
function WEIGHT_CHANGE(w1,w2,djdw1,djdw2){
  //This function chnages/updates the weights after every iteration
...
var hidden_nodes_size = 6;
var output_nodes_size = 1;
var num_of_iterations = 40000;
